        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-12">
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="date" name="ngay_sinh" class="form-control" <?php if ($read_email->ngay_sinh != "") { ?> value="<?php echo $read_email->ngay_sinh; ?>" <?php } else { ?> value="" <?php } ?> required data-validation-required-message="This field is required">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-12">
            ...
            <div class="col-lg-6 col-12">
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text" name="can_cuoc_cong_dan" class="form-control" <?php if ($read_email->can_cuoc_cong_dan != "") { ?> value="<?php echo $read_email->can_cuoc_cong_dan; ?>" <?php } else { ?> value="" <?php } ?> required data-validation-required-message="This field is required">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-12">
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text" name="so_the_bao_hiem" class="form-control" <?php if ($read_email->so_the_bao_hiem != "") { ?> value="<?php echo $read_email->so_the_bao_hiem; ?>" <?php } else { ?> value="" <?php } ?> required data-validation-required-message="This field is required">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-12">
            ...
            <div class="col-lg-6 col-12">
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text" name="nghe_nghiep" class="form-control" <?php if ($read_email->nghe_nghiep != "") { ?> value="<?php echo $read_email->nghe_nghiep; ?>" <?php } else { ?> value="" <?php } ?> required data-validation-required-message="This field is required">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-12">
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text" name="dia_chi" class="form-control" <?php if ($read_email->dia_chi != "") { ?> value="<?php echo $read_email->dia_chi; ?>" <?php } else { ?> value="" <?php } ?> required data-validation-required-message="This field is required">
                    </div>
                </div>
            </div>
