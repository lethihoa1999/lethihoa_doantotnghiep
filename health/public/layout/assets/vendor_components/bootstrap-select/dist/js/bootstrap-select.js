...
(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    clickListener: function () {
      ...
      this.$menuInner.on('click', '.divider, .dropdown-core', function (e) {
        e.preventDefault();
        e.stopPropagation();
    ...
    liveSearchListener: function () {
      ...
      this.$searchbox.on('input propertychange', function () {
        ...
        if (that.$searchbox.val()) {
          var $searchBase = that.$lis.not('.is-hidden, .divider, .dropdown-core'),
              $hideItems;
    ...
    changeAll: function (status) {
      ...
      var $options = this.$element.find('option'),
          $lisVisible = this.$lis.not('.divider, .dropdown-core, .disabled, .hidden'),
    ...
    keydown: function (e) {
      var $this = $(this),
          ...
          prevIndex,
          isActive,
          selector = ':not(.disabled, .hidden, .dropdown-core, .divider)',
          keyCodeMap = {
            32: ' ',
            48: '0',
            49: '1',
