...
var InteractiveDateComponent = /** @class */ (function (_super) {
    ...
    // is it allowed, in relation to the views's validRange?
...
var DayTableMixin = /** @class */ (function (_super) {
    ...
    /* Options
    ------------------------------------------------------------------------------------------------------------------*/
    // Computes a default column core formatting string if `colFormat` is not explicitly defined
    ...
    DayTableMixin.prototype.renderHeadDateCellHtml = function (date, colspan, otherAttrs) {
        ...
        // if only one row of days, the classNames on the core can represent the specific days beneath
        if (t.rowCnt === 1) {
            classNames = classNames.concat(
            // includes the day-of-week class
            // noThemeHighlight=true (don't highlight the core)
...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.showSegPopover = function (row, col, moreLink, segs) {
        ...
        var options;
        if (this.rowCnt === 1) {
            topEl = view.el; // will cause the popover to cover any sort of core
        }
        else {
    ...
    DayGrid.prototype.renderSegPopoverContent = function (row, col, segs) {
        ...
        var content = $('<div class="fc-core ' + theme.getClass('popoverHeader') + '">' +
...
function makeDayGridSubclass(SuperClass) {
    return /** @class */ (function (_super) {
        ...
        // Generates the HTML that will go before the day-of week core cells
...
var BusinessHourGenerator = /** @class */ (function () {
    ...
    BusinessHourGenerator.prototype.buildEventInstanceGroup = function (isAllDay, unzonedRange) {
        ...
        if (eventDefs.length) {
            ...
            // so that inverse-background rendering can happen even when no eventRanges in views
...
StandardTheme.prototype.classes = {
    ...
    popoverHeader: 'fc-widget-core',
    popoverContent: 'fc-widget-content',
    // day grid
    headerRow: 'fc-widget-core',
...
JqueryUiTheme.prototype.classes = {
    ...
    popoverHeader: 'ui-widget-core',
    popoverContent: 'ui-widget-content',
    // day grid
    headerRow: 'ui-widget-core',
...
var Calendar = /** @class */ (function () {
    ...
    Calendar.prototype.initialRender = function () {
        ...
        this.contentEl = $("<div class='fc-views-container'/>").prependTo(el);
        this.initToolbars();
        this.renderHeader();
        this.renderFooter();
    ...
    Calendar.prototype.bindViewHandlers = function (view) {
        ...
        view.watch('dateProfileForCalendar', ['dateProfile'], function (deps) {
            if (view === _this.view) {
                _this.currentDate = deps.dateProfile.date; // might have been constrained by views dates
    ...
    Calendar.prototype.renderView = function (viewType) {
        ...
        if (!this.view && viewType) {
            ...
            newView.setElement($("<div class='fc-views fc-" + viewType + "-views' />").appendTo(this.contentEl));
    ...
    // Unregsiters the `views`, but does not remove from viewByType hash.
...
var AgendaView = /** @class */ (function (_super) {
    ...
    function AgendaView(calendar, viewSpec) {
        ...
        if (_this.opt('allDaySlot')) {
            _this.dayGrid = _this.instantiateDayGrid(); // the all-day subcomponent of this views
            _this.addChild(_this.dayGrid);
        }
        _this.scroller = new Scroller_1.default({
            overflowX: 'hidden',
    ...
    AgendaView.prototype.updateSize = function (totalHeight, isAuto, isResize) {
        ...
        if (!isAuto) {
            ...
            scrollbarWidths = this.scroller.getScrollbarWidths();
            if (scrollbarWidths.left || scrollbarWidths.right) {
                // make the all-day and core rows lines up
...
var ListView = /** @class */ (function (_super) {
    ...
    ListView.prototype.renderSkeleton = function () {
        this.el.addClass('fc-list-views ' +
...
var OptionsManager = /** @class */ (function (_super) {
    ...
    OptionsManager.prototype.add = function (newOptionHash) {
        ...
        // catch-all. rerender the core and footer and rebuild/rerender the current views
...
Bootstrap3Theme.prototype.classes = {
    ...
    // day grid
    // for left/right border color when border is inset from edges (all-day in agenda views)
...
ViewRegistry_1.defineView('listDay', {
    ...
    duration: { days: 1 },
    defaults: {
        listDayFormat: 'dddd' // day-of-week is all we need. full date is probably in core
    }
});
