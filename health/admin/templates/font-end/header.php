        ...
        <div class="d-flex align-items-center logo-box justify-content-start">
            ...
            <a href="index.php" class="logo">
                ...
                <div class="logo-mini w-50">
                    <span class="light-logo"><img src="public/layout/images/anhdoan/logo1.png" alt="logo"></span>
                    <span class="dark-logo"><img src="public/layout/images/anhdoan/logo1.png" alt="logo"></span>
                </div>
                <div class="logo-lg">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu animated flipInX">
                            <li class="user-body">
                                <a class="dropdown-item" href="change_pass.php"><i class="ti-settings text-muted me-2"></i> Đổi mật khẩu</a>
