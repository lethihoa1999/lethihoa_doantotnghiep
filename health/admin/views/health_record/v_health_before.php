        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Quản lý hồ sơ sức khỏe trước tiêm</h3>
                        </div>
                        <div class="col-lg-6 col-12 d-flex align-items-sm-center">
                        <button type="submit" name="btnsearch" class="btn me-1 mt-sm-2" style="background-color: red; margin-left: 1.9%; width: 16%;" onclick="window.location.href='add_health.php?luot_tiem=1'"></i>Thêm</button>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="table-responsive">
                                <table cellspacing="0" cellpadding="5" id="example" class="table table-bordered table-striped" style="background-color: white;">
                                    ...
                                    <tbody>
                                    <?php foreach ($health_before as $key=>$value) { ?>
                                        <tr>
                                            <td><?php echo $m_health_before->read_customer_by_id($value->id_khach_hang)->ma_khach_hang;?></td>
                                            <td><?php echo $m_health_before->read_customer_by_id($value->id_khach_hang)->ho_ten;?></td>
                                            <td><?php echo $m_health_before->read_customer_by_id($value->id_khach_hang)->gioi_tinh;?></td>
                                            ...
                                            <td style="text-align: center; width: 13%;"><button type="button" class="btn btn-cyan btn-sm" onclick="window.location.href='edit_health_before.php?id=<?php echo $value->id;?>'">Edit</button>
                                            <button type="button" name="delete" class="btn btn-danger btn-sm" style="" onclick="window.location.href='delete_health_before.php?id=<?php echo $value->id;?>' " >Delete</button></td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                                </table>
