            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="box">
                        ...
                        <div class="col-lg-6 col-12 d-flex align-items-sm-center">
                        <button type="submit" name="btnsearch" class="btn me-1 mt-sm-2" style="background-color: red; margin-left: 1.9%;" onclick="window.location.href='add_health.php?luot_tiem=1'"></i>Thêm</button>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
